require 'aws-sdk-ecs'
require 'provisioner/commands/create_cluster'

RSpec.describe Provisioner::Commands::CreateCluster do
  let(:client) do
  ...
  describe '#call' do
    ...
    it 'logs its arn' do
      expect(Provisioner.logger).to receive(:info).with("Cluster created with arn: #{cluster_arn}")
