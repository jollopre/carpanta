require 'aws-sdk-ecs'
require 'provisioner/commands/create_service'

RSpec.describe Provisioner::Commands::CreateService do
  let(:client) do
  ...
  describe '#call' do
    ...
    it 'logs its arn' do
      expect(Provisioner.logger).to receive(:info).with('Service created with arn: a_service_arn')
